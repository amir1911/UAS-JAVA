...
public class SeatSelectionFrame extends JFrame {
    ...
    public SeatSelectionFrame(String username, int busId, int scheduleId) {
        this.currentUser = username;
        this.busId = busId;
        this.scheduleId = scheduleId;

        setTitle("Pilih Kursi - Bus " + busId);
        setSize(480, 540);
        setLayout(null);
    ...
    private void confirmBooking() {
        ...
        int harga = seatService.getBusPrice(busId); // harga dari database
